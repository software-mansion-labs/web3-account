...
console.log(
  "TYPE HASH:",
  "0x" +
    TypedDataUtils.hashType(typedData.primaryType, typedData.types).toString(
      "hex"
    )
);

let privateKey =
  "f95e53f6ba8055b25ac3c5576e818e57a84d5d68e03b73f5a441f0464f5980ae";
let address =
  "0x7156fb3c40b9636425931f57a87c507aa472d1b97d52859e5c68b9ba2b3570";
let selector =
  "0x1326ba54c1a0ca5f0593bfe36b9adeaf723e0ce0e8737bd108812706386cefb";
